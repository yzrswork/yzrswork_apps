...
self.addEventListener('fetch', (event) => {
  ...
  // nejiアプリの既知アセット以外は素通り（他ページに介入しない）
  if (!NEJI_ASSET_URLS.has(url.href)) {
    return;
  }
...
//
// === キャッシュ範囲 ===
// このSWは /neji/ スコープで、ASSETS配列に列挙された既知アセットのみキャッシュする。
// 他ページには介入しない。
