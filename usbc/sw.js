...
self.addEventListener('fetch', (event) => {
  ...
  // usbcアプリの既知アセット以外は素通り（他ページに介入しない）
  if (!USBC_ASSET_URLS.has(url.href)) {
    return;
  }
...
//
// === キャッシュ範囲 ===
// このSWは /usbc/ スコープで、ASSETS配列に列挙された既知アセットのみキャッシュする。
// 他ページには介入しない。
